...
//  };
    ...
    getGSTIN = async (scode) => {
        ...
        this.setState({loading: false,GSTIN: DropListGSTINs});
        return true
    }
    scodeFormSubmit = (e) => {
        e.preventDefault();
        this.setState({loading: true,scode: e.nativeEvent.target[0].value});
    };
    render() {
          ...
          <Grid.Row columns={1}>
            <Grid.Column style={{ maxWidth: 450 }}>
              ...
              <Form onSubmit={this.scodeFormSubmit}>
                ...
                <Button type='submit'>Get GSTINS</Button>
              </Form>
              <br/>
              {this.state.scode && this.getGSTIN(this.state.scode) && this.state.GSTIN != [] && <Dropdown
