...
const Report = React.memo(function Report({
  ...
  <div>
    <p>
      <span class="bold fs-mid">Reference Number: </span
      ><span class="bold">${GSTINDetails.reference_number}</span>
    </p>
      ...
      >
        <tbody>
          ...
          <tr style="height: 21px">
            ...
            <td>${checkRound(table14?.row1?.samt) ?? "-"}</td>
          ...
          <tr style="height: 21px">
            ...
            <td>${checkRound(table14?.row2?.samt) ?? "-"}</td>
